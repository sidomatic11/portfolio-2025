  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="w-full py-12">
        ...
        <Accordion title="User-centered product vision for a data fabric platform" defaultOpen={true} className="mb-8">
          ...
          <div className="w-full p-0.5 pb-4 bg-gray-100 rounded-lg  mb-12">
            <video
          ...
          <div className="w-full p-0.5 bg-gray-100 rounded-lg  mb-12">
          ...
          <div className="max-w-xl mx-auto p-6 bg-gray-100 rounded-lg mb-12">
        ...
        <Accordion title="Organized a virtual innovation workshop for Concentrix leadership" className="mb-8">
          ...
          <p className="max-w-xl mx-auto text-base mb-4 mt-8">Concentrix had started using the Virbela platform. Our team explored if we can use this <b>innovative platform</b> for an <b>innovation workshop.</b></p>
