...
export default function Header({ toggleExploreSolve, isExploreVisible, isProjectHeader }: { toggleExploreSolve?: () => void, isExploreVisible?: boolean, isProjectHeader?: boolean }) {
	...
	return (
		<header className="w-full flex items-center justify-between h-16 bg-white fixed bottom-0 left-0 right-0 shadow-[inset_0_1px_0_0_black] sm:top-0 sm:shadow-[0_1px_0_0_black]">
